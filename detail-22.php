        ...
        <div class="container" data-aos="fade-up">
            <div class="row gx-0">
              ...
              <div class="col-lg-6 align-middle" data-aos="zoom-out" data-aos-delay="200">
                  <img src="assets/img/oca.png" class="img-fluid" alt="">
              ...
              <div class="col-lg-5 offset-lg-1 d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
                <div class="card-desc">
                  <div class="card-body">
                    ...
                    <h4 class="fw-bolder">OCA Blast</h4>
                  ...
                  <div class="card-footer" style="text-align: justify;">
                    ...
                    <span>OCA Blast merupakan layanan yang digunakan oleh pengguna untuk mengirimkan pesan secara massal (push notification) melalui saluran komunikasi seperti SMS, Whatsapp, Email dan Voice (IVR). Kegunaan dari OCA Blast sendiri dapat membantu perusahaan untuk terus terhubung dengan jutaan pelanggan kapan pun dan di mana pun dengan mengirimkan pesan melalui berbagai saluran komunikasi secara instan dan otomatis. Layanan ini biasa digunakan untuk pengiriman pesan seperti, pemberian informasi, product knowledge, billing reminder, promosi, dan sebagainya yang membutuhkan layanan broadcast. OCA Blast beroperasi dengan menggunakan database milik user.</span>
                  </div>
                </div>
              </div>
