              ...
              <div class="col-lg-5 offset-lg-1 d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
                <div class="card-desc">
                  <div class="card-body">
                    ...
                    <h4 class="fw-bolder">SVCC : Virtual Training</h4>
                  ...
                  <div class="card-footer" style="text-align: justify;">
                    ...
                    <span>Beberapa training memiliki safety issues dan membutuhkan biaya yang tidak sedikit. Masa pandemi seperti ini membuat perusahaan harus menekan beberapa biaya, salah satunya training. SVCC menyediakan layanan pembuatan konten Virtual Reality (VR) dan Augmented Reality (AR) untuk berbagai kebutuhan bisnis dan enterprise seperti virtual training. Pelatihan yang dilakukan secara virtual dapat memberikan manfaat, seperti safety training, cost efficiency, dan interactive experience.</span>
                  </div>
                </div>
              </div>
