              ...
              <div class="col-lg-5 offset-lg-1 d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
                <div class="card-desc">
                  <div class="card-body">
                    ...
                    <h4 class="fw-bolder">OCA Whatsapp API</h4>
                  ...
                  <div class="card-footer" style="text-align: justify;">
                    ...
                    <span>Banyak dari konsumen yang menggunakan Whatsapp sebagai perantara dalam berkomunikasi. Fitur yang mudah membuat banyak konsumen dan pengusaha menjadikan Whatsapp sebagai platform untuk tetap terhubung. OCA menyediakan WhatsApp API untuk bisnis Anda. WhatsApp API Business menghubungkan Anda dengan pelanggan di WhatsApp dengan cara yang sederhana, aman, dan terpercaya. OCA Whatsapp API membantu Anda dalam mengirim pesan ke pelanggan dalam bentuk berbagai pilihan seperti promosi, update billing, dan lainnya.</span>
                  </div>
                </div>
              </div>
