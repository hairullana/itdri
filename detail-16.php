              ...
              <div class="col-lg-5 offset-lg-1 d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
                <div class="card-desc">
                  <div class="card-body">
                    ...
                    <h4 class="fw-bolder">BigOne: Business Process</h4>
                  ...
                  <div class="card-footer" style="text-align: justify;">
                    ...
                    <span>Sulitnya merencanakan dan merumuskan workflow management pada big data business process membuat terhambatnya proses analisa untuk pengambilan keputusan. BigBox menyediakan layanan analisis dan merencanakan proses big data bisnis suatu perusahaan dengan sistem workflow management. Dapat digunakan untuk mendukung pengambilan keputusan yang cepat, efektif, dan berlandaskan data yang tersedia.</span>
                  </div>
                </div>
              </div>
