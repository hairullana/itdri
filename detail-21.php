              ...
              <div class="col-lg-5 offset-lg-1 d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
                <div class="card-desc">
                  <div class="card-body">
                    ...
                    <h4 class="fw-bolder">OCA Interaction</h4>
                  ...
                  <div class="card-footer" style="text-align: justify;">
                    ...
                    <span>OCA Interaction merupakan layanan yang memungkinkan penggunanya untuk melakukan interaksi dengan audiens melalui berbagai saluran hanya dengan membuka satu dashboard. Layanan ini dapat diakses dimana saja sehingga agen dapat bekerja dimana saja dengan akses menggunakan internet. Menyediakan layanan CRM All-in-one yang memiliki fitur Inbox, Chatbot, Contact Management, Ticketing, Knowledge Base, Agent Rules, dan Insight untuk menjawab keluhan pelanggan secara real-time serta meningkatkan produktivitas agen.</span>
                  </div>
                </div>
              </div>
