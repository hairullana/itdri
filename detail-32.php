        ...
        <div class="container" data-aos="fade-up">
            <div class="row gx-0">
              ...
              <div class="col-lg-6 align-middle" data-aos="zoom-out" data-aos-delay="200">
                  <img src="assets/img/smarteye.png" class="img-fluid" alt="">
              ...
              <div class="col-lg-5 offset-lg-1 d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
                <div class="card-desc">
                  <div class="card-body">
                    ...
                    <h4 class="fw-bolder">SVCC : Virtual Expo</h4>
                  ...
                  <div class="card-footer" style="text-align: justify;">
                    ...
                    <span>Pandemi tidak mengenal kata kasihan. Perekonomian harus tetap bergerak. Sulitnya mengadakan expo di tengah pandemi merupakan halangan sekaligus tantangan bagaimana perusahaan mengenalkan produknya dan tetap terhubung dengan konsumen. Tak perlu khawatir, saat ini Smarteye Virtual Convention Center menyediakan layanan virtual expo. Virtual expo sendiri merupakan pameran online interaktif yang dapat menjangkau pengunjung atau konsumen dengan efisien menggunakan 3D Virtual Booth, 3D Environment, Webinar, Digital Information (text, video, foto, dan link), Landing page development, dan Event Analytics.</span>
                  </div>
                </div>
              </div>
