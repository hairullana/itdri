              ...
              <div class="col-lg-5 offset-lg-1 d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
                <div class="card-desc">
                  <div class="card-body">
                    ...
                    <h4 class="fw-bolder">Oca Profiling/h4>
                  ...
                  <div class="card-footer" style="text-align: justify;">
                    ...
                    <span>Customer profiling adalah metode untuk menyesuaikan target market, dan membantu bisnis melakukan strategi pemasaran, penjualan, dan survey lebih akurat, sehingga meningkatkan keberhasilan dari campaign yang dijalankan. Customer Profiling menjadikan marketing, sales, dan retention yang lebih baik. Fitur ini memiliki manfaat menyaring dan mengelola data calon konsumen agar perusahaan dapat menentukan prospek pelanggan yang tepat untuk strategi pemasaran yang akurat. OCA Profiling membantu dalam mengenali target pasar lebih akurat dan membantu meningkatkan efisiensi yang ada sehingga membuat biaya yang dikeluarkan menjadi lebih hemat.</span>
                  </div>
                </div>
              </div>
